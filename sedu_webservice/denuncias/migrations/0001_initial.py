# Generated by Django 2.2.6 on 2019-12-16 19:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_novo', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outroPapel', models.CharField(default='', max_length=255)),
                ('protocolo', models.CharField(default='', max_length=60)),
                ('data_ocorrido', models.DateTimeField()),
                ('placa_veiculo', models.CharField(default='', max_length=255)),
                ...
                ('papelAutor', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='denuncias.Papel')),
